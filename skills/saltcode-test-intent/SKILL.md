...
description: Guides the Test Intent agent to write one acceptance-test spec per task before any code exists, in the project's configured framework, without writing implementation.
---
